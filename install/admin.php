...
if (isset($_POST["btn_admin"])) {
    ...
    if (mysqli_connect_errno()) {
        ...
        if ($_SESSION["license"] == 'Regular License') {$license = 1;
        } else {$license = 2;}
        ...
        mysqli_query($connection, "UPDATE settings SET site_info='" . $license . "', ind_code='" . $_SESSION["license_code"] . "', purchase_code='" . $_SESSION["purchase_code"] . "', sid='" . $_SESSION["sold_at"] . "' WHERE id='1'");
