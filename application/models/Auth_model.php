<?php
/*
is logged user - дали е логнат
get user - вземане на потребител
is admin - дали е админ
is user - дали е потребител
is pro user - дали е pro потребител
logout - излизане
check_roles_email - проверка на ролите при имейл, при добавяне на role manager
check_email - проверка на имейла към кой потребител е
*/
