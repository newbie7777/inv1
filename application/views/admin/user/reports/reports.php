                            ...
                            <tbody>
                              <?php $total_ex_tax=0; $total=0; $r=1; foreach ($reports as $report): ?>
                                <tr id="row_<?php echo html_escape($report->id); ?>">
                                    ...
                                    <td><?php echo price_formatted($report->convert_total, $this->business->id); ?></td>
                                    <td><?php echo price_formatted($report->convert_total, $this->business->id); ?></td>
                            ...
                            <tbody>
                              <?php $total_ex_tax=0; $total=0; $e=1; foreach ($reports as $report): ?>
                                <tr id="row_<?php echo html_escape($report->id); ?>">
                                    ...
                                    <td><?php echo price_formatted($report->amount, $this->business->id); ?></td>
                                    <td><?php echo price_formatted($report->net_amount, $this->business->id); ?></td>
                                    <td><span class="label label-default"> <?php echo my_date_show($report->date); ?> </span></td>
                              ...
                              <div class="row report_info">
                                  ...
                                  <div class="col-md-6 text-right">
                                    <?php if (isset($_GET['tax_info']) && $_GET['tax_info'] == 1): ?>
                                      <p><span><?php echo trans('total') ?> (<?php echo trans('with-tax') ?>):</span> <?php echo price_formatted($total, $this->business->id); ?></p>
                                    <?php elseif (isset($_GET['tax_info']) && $_GET['tax_info'] == 2): ?>
                                      <p><span><?php echo trans('total') ?> (<?php echo trans('without-tax') ?>):</span> <?php echo price_formatted($total_ex_tax, $this->business->id); ?></p>
                                    <?php else: ?>
                                      <p><span><?php echo trans('total') ?>:</span> <?php echo price_formatted($total, $this->business->id); ?></p>
                                    <?php endif ?>
                                  </div>
                              </div>
                            </tbody>
